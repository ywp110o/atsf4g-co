...
actor_action_cs_req_base::msg_cptr_type actor_action_cs_req_base::get_cs_request() const {
...
actor_action_cs_req_base::msg_ptr_type actor_action_cs_req_base::get_cs_request() {
...
std::shared_ptr<player> actor_action_cs_req_base::get_player() const {
