...
task_action_player_info_get::task_action_player_info_get(): rsp_(NULL) {}
task_action_player_info_get::~task_action_player_info_get() {}

int task_action_player_info_get::operator()(hello::message_container& msg) {
    rsp_ = NULL;
...
int task_action_player_info_get::on_success() {
    return get_ret_code();
}
